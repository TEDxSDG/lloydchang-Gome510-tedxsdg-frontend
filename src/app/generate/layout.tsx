// File: src/app/generate/layout.tsx
"use client";
    ...
    <div className="font-sans bg-gray-50 flex">
      ...
      <nav className="w-64 bg-gray-100 min-h-screen shadow-md flex flex-col">
        ...
        <ul className="space-y-2 p-4">
          <li>
            <NavItem href="/generate/inspiration">1. Inspiration</NavItem>
          </li>
          <li>
            <NavItem href="/generate/planning">2. Planning</NavItem>
          </li>
          <li>
            <NavItem href="/generate/funding">3. Funding</NavItem>
          </li>
        </ul>
      </nav>
